...
final planetaryBoundaryFamily = StateNotifierProvider.autoDispose.family<
    PlanetaryBoundaryStateNotifier,
    EntityState<PlanetaryBoundaryMixin>,
    String>(
  (ref, id) {
    final cache = ref.read(entityCacheProvider.notifier);
    return PlanetaryBoundaryStateNotifier(id: id, cache: cache);
  },
);
